...
- projects a PNG character panel with `cv.projectPoints()`,
...
- `pose_estimation_ar.py`
  - main HW4 script
  - camera pose estimation + PNG-based AR rendering
...
- `assets/character.png`
  - your AR character image
  - should be a transparent PNG with alpha channel
...
5. Render a transparent PNG character as a vertical panel on the checkerboard plane.
6. Draw 3D axes for pose visualization.

The AR object is now designed to be your own PNG character or illustration rather than a simple wireframe object.
...
Before running it, place your PNG at:
...
- `assets/character.png` must have transparency for clean overlay.
